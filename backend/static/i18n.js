...
const TRANSLATIONS = {
  ru: {
    ...
    "catalog.emptyTitle": "Объекты не найдены",
    "catalog.errorTitle": "Каталог не загрузился",
    ...
    "filter.bedrooms.label": "Спален от",
    "filter.bedrooms.any": "Любое количество",
    "filter.sort.label": "Сортировка",
    "filter.sort.default": "По умолчанию",
    "filter.sort.priceAsc": "Цена: сначала ниже",
    "filter.sort.priceDesc": "Цена: сначала выше",
    "filter.sort.areaDesc": "Площадь: сначала больше",
    ...
    "inquiry.field.purpose": "Цель",
    "inquiry.field.budget": "Бюджет, USD",
    "inquiry.field.channel": "Предпочтительный канал связи",
    "inquiry.field.privacy": "Я ознакомился(-ась) с политикой конфиденциальности и согласен(-на) на обработку данных.",
    "inquiry.field.marketing": "Можно присылать мне релевантные обновления. Необязательно.",
    "inquiry.purpose.personal": "Для жизни",
    "inquiry.purpose.investment": "Инвестиция",
    "inquiry.purpose.relocation": "Переезд",
    "inquiry.purpose.other": "Другое",
    ...
    "details.title": "Детали объекта",
    "details.view": "Подробнее",
    "details.landmarks": "Расстояние до ориентиров",
    "details.distanceTo": "{distance} км до {landmark}",
    "details.amenities": "Удобства и особенности",
    "details.landmark.burj_khalifa": "Бурдж-Халифа (Даунтаун)",
    "details.landmark.palm_jumeirah": "Палм-Джумейра",
    "details.landmark.dubai_marina": "Дубай Марина",
    "details.landmark.mall_of_emirates": "Молл Эмирейтс",
    "details.landmark.dxb_airport": "Аэропорт DXB",
    "compare.label": "Сравнить",
    "compare.title": "Сравнение объектов",
    "compare.now": "Сравнить выбранные",
    "compare.clear": "Очистить список",
    "compare.limit": "Максимум 3 объекта для сравнения",
    "compare.empty": "Нет объектов для сравнения",
    "compare.added": "Добавлено к сравнению",
    "compare.removed": "Удалено из сравнения",
    "favorite.add": "В избранное",
    "favorite.remove": "В избранном",
  ...
  en: {
    ...
    "catalog.emptyTitle": "No listings found",
    "catalog.errorTitle": "The catalogue did not load",
    ...
    "filter.bedrooms.label": "Bedrooms from",
    "filter.bedrooms.any": "Any number",
    ...
    "filter.sort.areaDesc": "Area: largest first",
    ...
    "inquiry.field.purpose": "Purpose",
    "inquiry.field.budget": "Budget, USD",
    "inquiry.field.channel": "Preferred contact channel",
    "inquiry.field.privacy": "I have read the privacy notice and agree to the processing of my data.",
    "inquiry.field.marketing": "You may send relevant updates. Optional.",
    "inquiry.purpose.personal": "Personal use",
    "inquiry.purpose.investment": "Investment",
    "inquiry.purpose.relocation": "Relocation",
    "inquiry.purpose.other": "Other",
    ...
    "copy.code": "Copy",
    "copied.code": "Copied",
    "details.title": "Property Details",
    "details.view": "View Details",
    "details.landmarks": "Distance to Landmarks",
    "details.distanceTo": "{distance} km to {landmark}",
    "details.amenities": "Amenities & Features",
    "details.landmark.burj_khalifa": "Burj Khalifa (Downtown)",
    "details.landmark.palm_jumeirah": "Palm Jumeirah",
    "details.landmark.dubai_marina": "Dubai Marina",
    "details.landmark.mall_of_emirates": "Mall of the Emirates",
    "details.landmark.dxb_airport": "DXB Airport",
    "compare.label": "Compare",
    "compare.title": "Property Comparison",
    "compare.now": "Compare Selected",
    "compare.clear": "Clear Selected",
    "compare.limit": "Maximum 3 properties for comparison",
    "compare.empty": "No properties to compare",
    "compare.added": "Added to comparison",
    "compare.removed": "Removed from comparison",
    "favorite.add": "Save",
    "favorite.remove": "Saved",
    "favorite.added": "Saved to favourites",
  ...
  de: {
    ...
    "catalog.emptyTitle": "Keine Objekte gefunden",
    "catalog.errorTitle": "Der Katalog wurde nicht geladen",
    ...
    "filter.bedrooms.label": "Schlafzimmer ab",
    "filter.bedrooms.any": "Beliebige Anzahl",
    "filter.sort.label": "Sortieren nach",
    "filter.sort.default": "Standard",
    "filter.sort.priceAsc": "Preis: aufsteigend",
    "filter.sort.priceDesc": "Preis: absteigend",
    "filter.sort.areaDesc": "Fläche: größte zuerst",
    "filter.sort.newest": "Neueste zuerst",
    ...
    "inquiry.field.purpose": "Zweck",
    "inquiry.field.budget": "Budget, USD",
    "inquiry.field.channel": "Bevorzugter Kontaktkanal",
    "inquiry.field.privacy": "Ich habe den Datenschutzhinweis gelesen und stimme der Verarbeitung meiner Daten zu.",
    "inquiry.field.marketing": "Sie dürfen mir relevante Neuigkeiten senden. Optional.",
    "inquiry.purpose.personal": "Eigennutzung",
    "inquiry.purpose.investment": "Investition",
    "inquiry.purpose.relocation": "Umzug",
    "inquiry.purpose.other": "Sonstiges",
    "inquiry.channel.phone": "Telefon",
    ...
    "copy.code": "Kopieren",
    "copied.code": "Kopiert",
    "details.title": "Objektdetails",
    "details.view": "Details anzeigen",
    "details.landmarks": "Entfernung zu Sehenswürdigkeiten",
    "details.distanceTo": "{distance} km bis {landmark}",
    "details.amenities": "Ausstattung & Merkmale",
    "details.landmark.burj_khalifa": "Burj Khalifa (Downtown)",
    "details.landmark.palm_jumeirah": "Palm Jumeirah",
    "details.landmark.dubai_marina": "Dubai Marina",
    "details.landmark.mall_of_emirates": "Mall of the Emirates",
    "details.landmark.dxb_airport": "Flughafen DXB",
    "compare.label": "Vergleichen",
    "compare.title": "Immobilienvergleich",
    "compare.now": "Ausgewählte vergleichen",
    "compare.clear": "Auswahl aufheben",
    "compare.limit": "Maximal 3 Objekte zum Vergleichen",
    "compare.empty": "Keine Objekte zum Vergleichen",
    "compare.added": "Zum Vergleich hinzugefügt",
    "compare.removed": "Aus dem Vergleich entfernt",
    "favorite.add": "Merken",
    "favorite.remove": "Gemerkt",
  ...
  es: {
    ...
    "catalog.emptyTitle": "No se encontraron propiedades",
    "catalog.errorTitle": "El catálogo no se cargó",
    "catalog.retry": "Intentar de nuevo",
    ...
    "filter.bedrooms.label": "Dormitorios desde",
    "filter.bedrooms.any": "Cualquier cantidad",
    "filter.sort.label": "Ordenar por",
    "filter.sort.default": "Predeterminado",
    "filter.sort.priceAsc": "Precio: menor a mayor",
    "filter.sort.priceDesc": "Precio: mayor a menor",
    "filter.sort.areaDesc": "Superficie: mayor primero",
    "filter.sort.newest": "Más recientes primero",
    ...
    "inquiry.field.purpose": "Objetivo",
    "inquiry.field.budget": "Presupuesto, USD",
    "inquiry.field.channel": "Canal de contacto preferido",
    "inquiry.field.privacy": "He leído el aviso de privacidad y acepto el tratamiento de mis datos.",
    "inquiry.field.marketing": "Puede enviarme novedades relevantes. Opcional.",
    "inquiry.purpose.personal": "Uso personal",
    "inquiry.purpose.investment": "Inversión",
    "inquiry.purpose.relocation": "Mudanza",
    "inquiry.purpose.other": "Otro",
    ...
    "copy.code": "Copiar",
    "copied.code": "Copiado",
    "card.yearBuilt": "Año de construcción",
    "card.parking": "Estacionamiento",
    "card.features": "Características",
    "card.photos": "Fotos ({count})",
    "details.title": "Detalles de la propiedad",
    "details.view": "Ver detalles",
    "details.landmarks": "Distancia a puntos de interés",
    "details.distanceTo": "{distance} km a {landmark}",
    "details.amenities": "Servicios y características",
    "details.landmark.burj_khalifa": "Burj Khalifa (Centro)",
    "details.landmark.palm_jumeirah": "Palm Jumeirah",
    "details.landmark.dubai_marina": "Dubai Marina",
    "details.landmark.mall_of_emirates": "Mall of the Emirates",
    "details.landmark.dxb_airport": "Aeropuerto DXB",
    "compare.label": "Comparar",
    "compare.title": "Comparación de propiedades",
    "compare.now": "Comparar seleccionadas",
    "compare.clear": "Limpiar selección",
    "compare.limit": "Máximo 3 propiedades para comparar",
    "compare.empty": "No hay propiedades para comparar",
    "compare.added": "Añadida a la comparación",
    "compare.removed": "Eliminada de la comparación",
    "favorite.add": "Guardar",
    "favorite.remove": "Guardada",
    "favorite.added": "Guardada en favoritos",
    "favorite.removed": "Eliminada de favoritos",
  },
};
