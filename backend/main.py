...
def initialize_database() -> None:
    ...
    if listing_count == 0:
        ...
        listings = [
            (
                1,
                "Sky Penthouse — Burj Khalifa Residence",
                "Downtown Dubai",
                4_800_000,
                "Exclusive three-bedroom penthouse on the 72nd floor with floor-to-ceiling panoramic views of the Dubai Fountain and Arabian Gulf. Private elevator lobby, Bulthaup kitchen, and dedicated concierge.",
                None,
                3,
                4.0,
                420,
                ...
                "https://example.com/tours/burj-khalifa-penthouse",
                created_at,
            ),
            (
                2,
                ...
                "Palm Jumeirah",
                12_500_000,
                "Six-bedroom beachfront Signature Villa on the Palm Jumeirah frond tip with private beach, infinity pool, and unobstructed Atlantis views. Landscaped garden, staff quarters, and three-car garage.",
                None,
                6,
                7.0,
                850,
            ...
            (
                3,
                "Marina Skyline Residence",
                "Dubai Marina",
                1_250_000,
                "Four-bedroom waterfront apartment in a premium tower with full marina and sea views. Walk-in closets, Italian marble finishes, and residents-only infinity pool on the 50th floor.",
                None,
                4,
                3.5,
                260,
                ...
                "https://example.com/tours/marina-skyline",
                created_at,
            ),
            (
                4,
                "Contemporary Townhouse — Dubai Hills",
                "Dubai Hills Estate",
                2_100_000,
                "Four-bedroom contemporary townhouse overlooking the championship golf course. Open-plan living, private garden, rooftop terrace, and smart-home automation throughout.",
                None,
                4,
                4.5,
                340,
                ListingStatus.ACTIVE.value,
                TourType.MODEL_3D.value,
                "https://example.com/tours/dubai-hills-townhouse",
                created_at,
            ),
            (
                5,
                ...
                "DIFC, Dubai",
                3_400_000,
                "Three-bedroom duplex in the heart of Dubai International Financial Centre. Double-height living room, Gaggenau appliances, private study, and direct skybridge access to Gate Avenue.",
                None,
                3,
                3.5,
                285,
                ...
                TourType.PHOTO_360.value,
                "https://example.com/tours/difc-duplex",
                created_at,
            ),
            (
                6,
                "Beachfront Mansion — Jumeirah Bay Island",
                "Jumeirah Bay Island",
                18_000_000,
                "Seven-bedroom ultra-luxury mansion on Jumeirah Bay Island designed by a world-renowned architect. 25-metre private pool, home cinema, wellness spa, staff wing, and 180° coastline panorama.",
                None,
                7,
                8.5,
                1200,
                ListingStatus.ACTIVE.value,
                TourType.MODEL_3D.value,
                "https://example.com/tours/jumeirah-bay-mansion",
                created_at,
            ),
        ]
    ...
    seed = {
        1: {
            "images": _json.dumps([
                ...
                "https://images.unsplash.com/photo-1582407947092-87710e5ff3f4?w=800&q=80",
                "https://images.unsplash.com/photo-1600596542815-ffad4c153859?w=800&q=80",
                "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80",
            ]),
            "latitude": 25.1972, "longitude": 55.2744,
            "year_built": 2024, "parking": 2,
            "features": _json.dumps(["Burj Khalifa View", "Private Elevator", "Concierge", "Infinity Pool"]),
        },
        2: {
            "images": _json.dumps([
            ...
            "year_built": 2022, "parking": 3,
            "features": _json.dumps(["Private Beach", "Infinity Pool", "Staff Quarters", "Garden"]),
        },
        3: {
            "images": _json.dumps([
                "https://images.unsplash.com/photo-1600596542815-ffad4c153859?w=800&q=80",
            ...
            "features": _json.dumps(["Marina View", "Rooftop Pool", "Gym", "Smart Home"]),
        },
        4: {
            "images": _json.dumps([
            ...
            "latitude": 25.0980, "longitude": 55.2380,
            "year_built": 2023, "parking": 2,
            "features": _json.dumps(["Golf Course View", "Private Garden", "Rooftop Terrace", "Smart Home"]),
        },
        5: {
            "images": _json.dumps([
                "https://images.unsplash.com/photo-1600596542815-ffad4c153859?w=800&q=80",
            ...
            "latitude": 25.2104, "longitude": 55.2817,
            "year_built": 2025, "parking": 2,
            "features": _json.dumps(["DIFC Skybridge", "Double Height Ceiling", "Study", "Concierge"]),
        },
        6: {
            "images": _json.dumps([
                "https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&q=80",
            ...
            "latitude": 25.2048, "longitude": 55.2548,
            "year_built": 2024, "parking": 4,
            "features": _json.dumps(["Private Beach", "Home Cinema", "Spa", "Staff Wing", "25m Pool"]),
        },
    }
